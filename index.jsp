...
<head>
  ...
  <!--    <link rel="stylesheet" href="static/css/bootstrap.min.css">  -->
    ...
    <link rel="stylesheet" href="static/css/ui-autocomplete.css">
     
    <style>
     #space{
     padding:3px 3px 0px 3px;
     background-color:rgb(27, 73, 212);
      color:white;
     }
     .right{
     color:white;
...
<body class="">
                                        ...
                                        <a href="#hotel" class="cus-btn primary " aria-current="false" data-bs-toggle="tab">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewbox="0 0 32 32" fill="none">
                                                <g clip-path="url(#clip0_502_1334)">
                                                    <path d="M10.7589 9.00703H12.6339V10.882H10.7589V9.00703Z" fill="#16191A"></path>
                                                    <path d="M10.7589 13.3106H12.6339V15.1856H10.7589V13.3106Z" fill="#16191A"></path>
                                                    <path d="M19.3661 13.3106H21.2411V15.1856H19.3661V13.3106Z" fill="#16191A"></path>
                                                    <path d="M23.6696 13.3106H25.5446V15.1856H23.6696V13.3106Z" fill="#16191A"></path>
                                                    <path d="M19.3661 17.6142H21.2411V19.4892H19.3661V17.6142Z" fill="#16191A"></path>
                                                    <path d="M23.6696 17.6142H25.5446V19.4892H23.6696V17.6142Z" fill="#16191A"></path>
                                                    <path d="M19.3661 21.9178H21.2411V23.7928H19.3661V21.9178Z" fill="#16191A"></path>
                                                    <path d="M23.6696 21.9178H25.5446V23.7928H23.6696V21.9178Z" fill="#16191A"></path>
                                                    <path d="M19.3661 26.2213H21.2411V28.0963H19.3661V26.2213Z" fill="#16191A"></path>
                                                    <path d="M23.6696 26.2213H25.5446V28.0963H23.6696V26.2213Z" fill="#16191A"></path>
                                                    <path d="M6.45538 13.3106H8.33037V15.1856H6.45538V13.3106Z" fill="#16191A"></path>
                                                    <path d="M10.7589 17.6142H12.6339V19.4892H10.7589V17.6142Z" fill="#16191A"></path>
                                                    <path d="M6.45538 17.6142H8.33037V19.4892H6.45538V17.6142Z" fill="#16191A"></path>
                                                    <path d="M10.7589 21.9178H12.6339V23.7928H10.7589V21.9178Z" fill="#16191A"></path>
                                                    <path d="M6.45538 21.9178H8.33037V23.7928H6.45538V21.9178Z" fill="#16191A"></path>
                                                    <path d="M29.8482 30.5249V9.00703H16.9375V4.53428L14.7857 4.8929V0.399902H4.30356V6.63997L2.15181 6.99859V30.5249H0V32.3999H32V30.5249H29.8482ZM27.9732 10.882V30.5249H16.9375V10.882H27.9732ZM6.17856 2.2749H12.9107V5.2054L6.17856 6.32747V2.2749ZM4.02681 8.58696L15.0625 6.74765V30.5249H12.6339V26.2213H6.45538V30.5249H4.02681V8.58696ZM10.7589 30.5249H8.33037V28.0963H10.7589V30.5249Z" fill="#16191A"></path>
                                                </g>
                                                <defs>
                                ...
                                <div class="tab-pane active" id="flight">
                                    <div class="card">
                                        <div class="card-header">
                                            <ul class="nav nav-tabs card-header-tabs " data-bs-tabs="tabs">
                                                <li class="nav-item">
                                                    <a href="#stopover" class="cus-btn primary-light primary active" aria-current="true" data-bs-toggle="tab">
                                                        Stopover
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="#manage" class="cus-btn primary-light primary " aria-current="false" data-bs-toggle="tab">
                                                        Manage Booking / Check in
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="#status" class="cus-btn primary-light primary " aria-current="false" data-bs-toggle="tab">
                                                        Flight Status
                                                    </a>
                                                </li>
                                            </ul>
    ...
    <!-- Flight_search_from -->         
         <form action="flight-listing.jsp" method="post">
                                                    ...
                                                    <div class="booking-info mb-32">
                                                        <div class="d-xl-flex align-items-center gap-24 d-lg-block d-flex">
                                                            <div class="custom-sel-input-block">
                                                                ...
                                                                <input type="text" name="source" class="sel-input auto-input" id="flightFrom" placeholder="From" required>
                                                                <div class="slector-wrapper"></div>
                                                            </div>
                                                            <div class="arrows">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none">
                                                                    <g clip-path="url(#clip0_518_2277)">
                                                                        <path d="M23.6804 6.07409L18.2259 0.619583C17.7999 0.193537 17.1092 0.193537 16.6831 0.619583C16.2571 1.04563 16.2571 1.73628 16.6831 2.16233L20.2754 5.75464H1.09096C0.488472 5.75464 3.51626e-05 6.24307 3.51626e-05 6.84556C3.51626e-05 7.44804 0.488472 7.93648 1.09096 7.93648H20.2754L16.6832 11.5287C16.2571 11.9548 16.2571 12.6455 16.6832 13.0715C16.8961 13.2845 17.1753 13.391 17.4545 13.391C17.7337 13.391 18.0129 13.2845 18.2258 13.0714L23.6804 7.61688C24.1064 7.19084 24.1064 6.50013 23.6804 6.07409Z" fill="#4D73FC"></path>
                                                                        <path d="M22.9091 16.6637H3.72462L7.31683 13.0714C7.74288 12.6453 7.74288 11.9547 7.31683 11.5286C6.89088 11.1026 6.20013 11.1026 5.77409 11.5286L0.319535 16.9831C-0.106512 17.4092 -0.106512 18.0998 0.319535 18.5259L5.77404 23.9804C5.98713 24.1935 6.26627 24.3 6.54546 24.3C6.82465 24.3 7.10388 24.1935 7.31679 23.9804C7.74283 23.5544 7.74283 22.8637 7.31679 22.4377L3.72457 18.8455H22.9091C23.5116 18.8455 24 18.357 24 17.7546C24 17.1521 23.5116 16.6637 22.9091 16.6637Z" fill="#4D73FC"></path>
                                                                    </g>
                                                                    <defs>
                                                            ...
                                                            <div class="custom-sel-input-block">
                                                                ...
                                                                <input type="text" name="destination" class="sel-input auto-input" id="flightTo" placeholder="To" required>
                                                                <div class="slector-wrapper"></div>
                                                            </div>
                                                        ...
                                                        <div class="d-xl-flex align-items-center gap-24 d-lg-block ">
                                                            <div class="input-date-picker">
                                                                ...
                                                                <input type="text" name="departing" class="sel-input date_from" id="flightDep" placeholder="Aug 18, 2023" required>
                                                            </div>
                                                            <div class="input-date-picker">
                                                                <label for="flightTime" class="h-16 color-medium-gray">Returning</label>
                                                                <input type="text" name="returning" class="sel-input date_to" id="flightTime" placeholder="Aug 20, 2023" required>
                                                            </div>
                                                            <div class="custom-sel-input-block ">
                                                                <div class="h-16 color-medium-gray mb-2">Passengers and Class</div>
                                                                <div class="seat-booking color-medium-gray"> <span class="total-pasenger">0</span> Passengers / <span class="pasenger-class">Business</span></div>
                                                                ...
                                                                <div class="passenger-area pessenger-box bg-white light-shadow br-5 p-24">
                                                                    ...
                                                                    <div class="radio-tile-group">
                                                                        <div class="input-container">
                                                                            <input id="economy" class="radio-button" type="radio" name="radio" value="Economy">
                                                                            <div class="radio-tile">
                                                                                <label for="economy" class="radio-tile-label">Economy</label>
                                                                            </div>
                                                                        </div>
                                                                        <div class="input-container">
                                                                            <input id="business" class="radio-button" type="radio" name="radio" value="Business">
                                                                            <div class="radio-tile">
                                                                                <label for="business" class="radio-tile-label">Business</label>
                                                                            </div>
                                                                        </div>
                                                                        <div class="input-container">
                                                                            <input id="firstClass" class="radio-button" type="radio" name="radio" value="First Class">
                                                                            <div class="radio-tile">
                                                                                <label for="firstClass" class="radio-tile-label">First
                                                                                    Class</label>
                                                                            </div>
                                                                        </div>
                                                                        <div class="input-container">
                                                                            <input id="pre-eco" class="radio-button" type="radio" name="radio" value="Premium Economy">
                                                                            <div class="radio-tile">
                                                                                <label for="pre-eco" class="radio-tile-label">Premium
                                                                                    Economy</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div class="row align-items-center">
                                                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 mb-xl-0 mb-24">
                                                            <h5 class="color-medium-gray mb-24">When would you like stop in dubai during your journey?</h5>
                                                            <div class="custom-control ">
                                                                <div class=" radio-button">
                                                                    <input type="radio" name="flight" class="custom-control-input" id="departure">
                                                                    <label class="custom-control-label" for="departure">Departure</label>
                                                                </div>
                                                                <div class=" radio-button">
                                                                    <input type="radio" name="flight" class="custom-control-input" id="return">
                                                        ...
                                                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 mb-xl-0 mb-24">
                                                            ...
                                                            <div class="quantity quantity-wrap">
                                                                <input class="decrement" type="button" value="-">
                                                                <input type="text" name="quantity" value="0" maxlength="2" size="1" id="adultQunatity" class="number">
                                                                <input class="increment" type="button" value="+">
                                                            </div>
                                                        </div>
    ...
    <!--  
                                            ...
                                            <div class="tab-pane" id="manage">
                                                ...
                                                <div class="card-body tab-content">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                                                <div class="custom-sel-input-block v-2">
                                                                                    <input type="text" class="sel-input" name="reference" id="ref-name" placeholder="Booking Reference">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                                                <div class="custom-sel-input-block m-0">
                                                                                    <input type="text" class="sel-input" name="name" id="last-name" placeholder="Last Name">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div class="tab-pane " id="checkIn">
                                                        <form action="flight-booking.jsp" method="post">
                                                            <div class="row align-items-center">
                                                                <div class="col-xl-10 col-lg-10 col-md-10">
                                                                    <div class="booking-info d-block">
                                                                        <div class="row">
                                                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                                                <div class="custom-sel-input-block v-2 m-0">
                                                                                    <input type="text" class="sel-input" name="reference" id="refNname" placeholder="Booking Reference">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                                                <div class="custom-sel-input-block m-0">
                                                                                    <input type="text" class="sel-input" name="name" id="lasName" placeholder="Last Name">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="row align-items-center">
                                                                <div class="col-xl-10 col-lg-10">
                                                                    <div class="booking-info v-2 d-md-flex d-inline-block justify-content-between">
                                                                            ...
                                                                            <div class="custom-sel-input-block m-0">
                                                                                <input type="text" name="source" class="sel-input auto-input" id="flightDepart" placeholder="From" required>
                                                                                <div class="slector-wrapper"></div>
                                                                            </div>
                                                                            <div class="custom-sel-input-block m-0 d-flex flex-row align-items-center">
                                                                                <div class="vertical-line d-md-flex d-none"></div>
                                                                                <input type="text" name="destination" class="sel-input auto-input" id="flightArrive" placeholder="To" required>
                                                                                <div class="slector-wrapper"></div>
                                                                            </div>
                                                                        
                                                                        <div>
                                                                            <div class="input-date-picker date-time m-0">
                                                                                <input type="text" name="departing" class="sel-input date_from" id="flightTimeDate" placeholder="Aug 20, 2023" required>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
          ...
          <!-- search flight status from start -->
                                                        <form action="flight-listing.jsp" method="post">
                                                            <div class="row align-items-center">
                                                                <div class="col-xl-10 col-lg-10">
                                                                    <div class="booking-info v-2 d-md-flex d-inline-block justify-content-between">
                                                                            ...
                                                                            <div class="custom-sel-input-block m-0">
                                                                                <input type="text" name="source" class="sel-input auto-input" id="flightDepat"  placeholder="From" required>
                                                                                <div class="slector-wrapper"></div>
                                                                            </div>
                                                                            <div class="custom-sel-input-block m-0 d-flex flex-row align-items-center">
                                                                                <div class="vertical-line d-md-flex d-none"></div>
                                                                                <input type="text" name="destination" class="sel-input auto-input" id="flightArive" placeholder="To" required>
                                                                                <div class="slector-wrapper"></div>
                                                                            </div>
                                                                        
                                                                        <div>
                                                                            <div class="input-date-picker date-time m-0">
                                                                                <input type="text" name="departing" class="sel-input date_from" id="flightTieDate" placeholder="Aug 20, 2023" required>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
  ...
  <!-- Hotel tab Start -->
                                <div class="tab-pane" id="hotel">
                                    <form action="hotel-listing.jsp" method="post">
                                        <div class="row align-items-center">
                                            <div class="col-xxl-10 col-xl-12">
                                                <div class="booking-info">
                                                    <div>
                                                        <div class="custom-sel-input-block">
                                                            <input type="text" name="destination" class="sel-input auto-input-hotel" id="flight_Destination" placeholder="Destination">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="d-md-flex justify-content-between d-sm-block">
                                                        <div class="input-date-picker">
                                                            ...
                                                            <input type="text" name="check_in" class="sel-input date_from" id="checkIn_19" placeholder="Aug 18, 2023">
                                                        </div>
                                                        <div class="vertical-line d-xl-flex d-none"></div>
                                                        <div class="input-date-picker">
                                                            <label for="checkOut_20" class="h-16 color-medium-gray">Check Out</label>
                                                            <input type="text" name="check_out" class="sel-input date_to" id="checkOut_20" placeholder="Aug 20, 2023">
                                                        </div>
                                                    </div>
                                                    <div class="vertical-line d-xl-flex d-none"></div>
                                                    <div>
                                                        <div class="custom-sel-input-block">
                                                            ...
                                                            <div class="room-booking color-black"> <span class="total-guest">2</span> Guests / <span class="guest-class">Room</span></div>
                                            ...
                                            <div class="col-xxl-2 mt-xxl-0 mt-32">
                                                <button type="submit" class="cus-btn extra-width">Search</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                ...
                                <div class="tab-pane" id="rental">
                                        ...
                                        <div class="card-header">
                                            <ul class="nav nav-tabs card-header-tabs " data-bs-tabs="tabs">
                                                <li class="nav-item v-2">
                                                    <a href="#carRental" class="cus-btn primary-light primary active" aria-current="true" data-bs-toggle="tab">
                                                        Car Rental
                                                    </a>
                                                </li>
                                                <li class="nav-item v-2">
                                                    <a href="#airPort" class="cus-btn primary-light primary" aria-current="false" data-bs-toggle="tab">
                                                        Airport Transfer
                                                    </a>
                                                </li>
                                            </ul>
                                   ...
                                   <form action="car-listing.jsp" method="post">
                                                                ...
                                                                <div class="row align-items-center">
                                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                                        <div class="custom-sel-input-block location-select">
                                                                            ...
                                                                            <input type="text" name="pick_up" class="sel-input location-input auto-input-location" id="pick_Up" placeholder="Pick-up Location">
                                                                            <div class="slector-wrapper"></div>
                                                                        </div>
                                                                    ...
                                                                    <div class="col-lg-6 col-md-6 col-sm-6 d-flex gap-8">
                                                                        ...
                                                                        <div class="custom-sel-input-block location-select">
                                                                            ...
                                                                            <i class="fal fa-map-marker-alt"></i>
                                                                            <input type="text" name="drop_off" class="sel-input location-input auto-input-location" id="drop_Off" placeholder="Drop-off Location">
                                                                            <div class="slector-wrapper"></div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="col-md-6 col-sm-6 mb-sm-0 mb-16">
                                                                        <div class="custom-sel-input-block m-0">
                                                                            ...
                                                                            <div class="d-flex align-items-center gap-8">
                                                                                ...
                                                                                <input type="text" name="start" class="sel-input date_from" id="pickUpDate" placeholder="Start Date">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-5 col-sm-5">
                                                                        <div class="input-date-picker">
                                                                            <div class="d-flex align-items-center gap-8">
                                                                                ...
                                                                                <input type="text" class="sel-input location-input timepicker p-0" id="time_Date">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row align-items-center">
                                                                    <div class="col-md-6 col-sm-6 mb-sm-0 mb-16">
                                                                        <div class="custom-sel-input-block m-0">
                                                                            ...
                                                                            <div class="d-flex align-items-center gap-8">
                                                                                <i class="fal fa-calendar-alt "></i>
                                                                                <input type="text" name="end" class="sel-input date_to" id="date_return" placeholder="End Date">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-1 col-sm-1 d-sm-block d-none p-0">
                                                                    ...
                                                                    <div class="col-md-5 col-sm-5">
                                                                        <div class="input-date-picker">
                                                                            <div class="d-flex align-items-center gap-8">
                                                                                <i class="fal fa-clock"></i>
                                                                                <input type="text" class="sel-input location-input timepicker p-0" id="flightTimePick">
                                                                            </div>
                                                                         </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="col-xl-12 mb-xl-0 mb-16">
                                                            <div class="booking-info d-block">
                                                                <div class="row align-items-center">
                                                                    <div class="col-lg-6">
                                                                        <div class="custom-sel-input-block location-select">
                                                                            <label for="flight_locationInput" class="h-16 color-medium-gray">Pick-up Location</label>
                                                                            <i class="fal fa-map-marker-alt"></i>
                                                                            <input type="text" class="sel-input location-input auto-input-location" id="flight_locationInput" placeholder="Pick-up Location">
                                                                            <div class="slector-wrapper"></div>
                                                                        </div>
                                                                    ...
                                                                    <div class="col-lg-6 d-flex gap-8">
                                                                        ...
                                                                        <div class="custom-sel-input-block location-select">
                                                                            ...
                                                                            <i class="fal fa-map-marker-alt"></i>
                                                                            <input type="text" class="sel-input location-input auto-input-location" id="flight_dropOff" placeholder="Drop-off Location">
                                                                            <div class="slector-wrapper"></div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row align-items-center">
                                                                    <div class="col-md-6 col-sm-6 mb-sm-0 mb-16">
                                                                        <div class="custom-sel-input-block m-0">
                                                                            ...
                                                                            <div class="d-flex align-items-center gap-8">
                                                                                <i class="fal fa-calendar-alt "></i>
                                                                                <input type="text" class="sel-input date_from" id="flight_ArrivalDate" placeholder="Pick-up Date">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-1 col-sm-1 d-sm-block d-none p-0">
                                                                    ...
                                                                    <div class="col-md-5 col-sm-5">
                                                                        <div class="input-date-picker">
                                                                            <div class="d-flex align-items-center gap-8">
                                                                                <i class="fal fa-clock"></i>
                                                                                <input type="text" class="sel-input location-input timepicker p-0" id="time_location">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row align-items-center">
                                                                    <div class="col-md-6 col-sm-6 mb-sm-0 mb-16">
                                                                        <div class="custom-sel-input-block m-0">
                                                                            ...
                                                                            <div class="d-flex align-items-center gap-8">
                                                                                <i class="fal fa-calendar-alt"></i>
                                                                                <input type="text" class="sel-input date_to" id="flight_returnDate" placeholder="Return Date">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-1 col-sm-1 d-sm-block d-none p-0">
                                                                    ...
                                                                    <div class="col-md-5 col-sm-5">
                                                                        <div class="input-date-picker">
                                                                            <div class="d-flex align-items-center gap-8">
                                                                                <i class="fal fa-clock"></i>
                                                                                <input type="text" class="sel-input location-input timepicker p-0" id="flight_timeNow">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="col-xxl-4 ">
                                                            <div class="booking-info">
                                                                <div class="custom-sel-input-block location-select">
                                                                    ...
                                                                    <input type="text" class="sel-input location-input" id="passenger_Popup" placeholder="Number of Passenger"> 
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-6 col-md-6 mb-xl-0 mb-24">
                            <div class="benefit-block bg-white">
                                <div class="image-box">
                                    <img src="static/picture/benefit-1.png" alt="">
                                </div>
                                <div class="text-box">
                                    <h4 class="lightest-black mb-8">We are Now Available</h4>
                                    <p class="color-medium-gray">Call +1 234 567 890 contact with us</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-6 col-md-6 mb-lg-0 mb-24">
                            <div class="benefit-block bg-white">
                                <div class="image-box">
                                    <img src="static/picture/benefit-2.png" alt="">
                                </div>
                                <div class="text-box">
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 ">
                            <div class="benefit-block bg-white">
                                <div class="image-box">
                                    <img src="static/picture/benefit-3.png" alt="">
                                </div>
                                <div class="text-box">
     ...
     <!-- **************************************************************************************************************************************************** -->
            ...
            <section class="flight-card p-40 mb-40" data-sal="slide-down" data-sal-duration="800" data-sal-delay="100" data-sal-easing="ease-in-out">
                <div class="container-fluid">
                    <h3 class="lightest-black h-36 bold mb-40">Latest Flight Deals</h3>
                    <div class="flight-card-slider slick-slider">
                        <div class="flight-deal-block bg-white p-24">
                            <div class="image-box mb-24">
                                <a href="flight-booking.jsp"><img src="static/picture/flight-1.png" alt=""></a>
                            </div>
                            <div class="content-box">
                                <h5 class="color-black mb-8"><a href="flight-booking.html">Dubai to Dhaka</a></h5>
                                <p class="light-black mb-24">14 Aug, 2023 - 20 Aug 2023</p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="price">
                                        <h6 class="light-black mb-8 fw-500">Economy Class</h6>
                                        <h5 class="lightest-black fw-500">Rs400</h5>
                                    </div>
                                    <a href="flight-booking.jsp" class="cus-btn small-pad">Booking Now</a>
                                </div>
                            </div>
                        </div>
                        <div class="flight-deal-block bg-white p-24">
                            <div class="image-box mb-24">
                                <a href="flight-booking.jsp"><img src="static/picture/flight-2.png" alt=""></a>
                            </div>
                            <div class="content-box">
                                <h5 class="color-black mb-8"><a href="flight-booking.html">Dubai to Thailand</a></h5>
                                <p class="light-black mb-24">14 Aug, 2023 - 20 Aug 2023</p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="price">
                                        <h6 class="light-black mb-8 fw-500">Premium Class</h6>
                                        <h5 class="lightest-black fw-500">Rs540</h5>
                                    </div>
                                    <a href="flight-booking.jsp" class="cus-btn small-pad">Booking Now</a>
                                </div>
                            </div>
                        ...
                        <div class="flight-deal-block bg-white p-24">
                            <div class="image-box mb-24">
                                <a href="flight-booking.jsp"><img src="static/picture/flight-3.png" alt=""></a>
                            </div>
                            <div class="content-box">
                                <h5 class="color-black mb-8"><a href="flight-booking.html">Dubai to Maldives</a></h5>
                                <p class="light-black mb-24">14 Aug, 2023 - 20 Aug 2023</p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="price">
                                        <h6 class="light-black mb-8 fw-500">Business Class</h6>
                                        <h5 class="lightest-black fw-500">Rs980</h5>
                                    </div>
                                    <a href="flight-booking.jsp" class="cus-btn small-pad">Booking Now</a>
                                </div>
                            </div>
                        ...
                        <div class="flight-deal-block bg-white p-24">
                            <div class="image-box mb-24">
                                <a href="flight-booking.jsp"><img src="static/picture/flight-4.png" alt=""></a>
                            </div>
                            <div class="content-box">
                                <h5 class="color-black mb-8"><a href="flight-booking.html">Dubai to Canada</a></h5>
                                <p class="light-black mb-24">14 Aug, 2023 - 20 Aug 2023</p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="price">
                                        <h6 class="light-black mb-8 fw-500">First Class</h6>
                                        <h5 class="lightest-black fw-500">Rs5000</h5>
                                    </div>
                                    <a href="flight-booking.jsp" class="cus-btn small-pad">Booking Now</a>
                                </div>
                            </div>
            ...
            <section class="global-travel-hotel p-40">
                <div class="container-fluid">
                    <div class="d-flex justify-content-between mb-40 flex-md-nowrap flex-wrap">
                        ...
                        <a href="hotel-listing.jsp" class="cus-btn ">Show More</a>
                    </div>
                    <div class="row">
                        <div class="col-xxl-6 col-lg-5" data-sal="slide-right" data-sal-duration="800" data-sal-delay="100" data-sal-easing="ease-in-out">
                            <img src="static/picture/map.png" alt="">
                        </div>
                        <div class="col-xxl-6 col-lg-7">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6" data-sal="slide-left" data-sal-duration="800" data-sal-delay="100" data-sal-easing="ease-in-out">
                                    <div class="hotel-block bg-white p-24 light-shadow mb-24">
                                        <div class="image-box mb-24">
                                            <a href="hotel-detail.jsp"><img src="static/picture/image-1.png" alt=""></a>
                                            <div class="price">
                                                <h6>form <span class="color-sec">Rs350</span></h6>
                                            </div>
                                        </div>
                                        <div class="content-box">
                                            <h5 class="black mb-8"><a href="hotel-detail.html">Rome</a></h5>
                                            <div class="d-flex gap-8 mb-24">
                                                <div class="icon d-flex align-items-center gap-8">
                                                    <img src="static/picture/location.png" alt="">
                                            ...
                                            <a href="hotel-detail.jsp" class="cus-btn full-width">Discover</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="hotel-block bg-white p-24 light-shadow mb-24">
                                        <div class="image-box mb-24">
                                            <a href="hotel-detail.jsp"><img src="static/picture/image-2.png" alt=""></a>
                                            <div class="price">
                                                <h6>form <span class="color-sec">Rs260</span></h6>
                                            </div>
                                        </div>
                                        <div class="content-box">
                                            <h5 class="black mb-8"><a href="hotel-detail.jsp">Tokyo</a></h5>
                                            <div class="d-flex gap-8 mb-24">
                                                <div class="icon d-flex align-items-center gap-8">
                                                    <img src="static/picture/location.png" alt="">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="hotel-block bg-white p-24 light-shadow mb-24">
                                        <div class="image-box mb-24">
                                            <a href="hotel-detail.jsp"><img src="static/picture/image-3.png" alt=""></a>
                                            <div class="price">
                                                <h6>form <span class="color-sec">Rs290</span></h6>
                                            </div>
                                        </div>
                                        <div class="content-box">
                                            <h5 class="black mb-8"><a href="hotel-detail.jsp">Sydney</a></h5>
                                            <div class="d-flex gap-8 mb-24">
                                                <div class="icon d-flex align-items-center gap-8">
                                                    <img src="static/picture/location.png" alt="">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="hotel-block bg-white p-24 light-shadow mb-24">
                                        <div class="image-box mb-24">
                                            <a href="hotel-detail.jsp"><img src="static/picture/image-4.png" alt=""></a>
                                            <div class="price">
                                                <h6>form <span class="color-sec">Rs340</span></h6>
                                            </div>
                                        </div>
                                        <div class="content-box">
                                            <h5 class="black mb-8"><a href="hotel-detail.jsp">London</a></h5>
                                            <div class="d-flex gap-8 mb-24">
                                                <div class="icon d-flex align-items-center gap-8">
                                                    <img src="static/picture/location.png" alt="">
        ...
        <footer class="bg-white p-40" data-sal="slide-down" data-sal-duration="800" data-sal-delay="100" data-sal-easing="ease-in-out">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                        <h4 class="light-black mb-16">Follow Us!</h4>
