...
<head>
    ...
    <link rel="stylesheet" href="static/css/smart_wizard_all.css">
...
<body class="o-scroll" id="js-scroll">
    ...
    <div id="main-wrapper" class="main-wrapper overflow-hidden">
                            ...
                            <div class="card-header">
                                <ul class="nav nav-tabs card-header-tabs " data-bs-tabs="tabs">
                                    <li class="nav-item flight-sec">
                                        <a href="#flight" class="cus-btn primary-light primary active" aria-current="true" data-bs-toggle="tab">
                                            Flight
                                        </a>
                                    </li>
                                    <li class="nav-item flight-sec">
                                        <a href="#stopover" class="cus-btn primary-light primary" aria-current="false" data-bs-toggle="tab">
                                            Stopover
                                        </a>
                                    </li>
                                    <li class="nav-item flight-sec">
       ...
       <form action="flight-listing.jsp" >
                                        ...
                                        <div class="booking-info mb-32" data-sal="slide-left" data-sal-duration="800" data-sal-delay="100" data-sal-easing="ease-in-out">
                                            <div class="d-xl-flex align-items-center gap-24 d-lg-block d-flex">
                                                <div class="custom-sel-input-block">
                                                    <label for="depFrom" class="h-16 color-medium-gray">From</label>
                                                    <input type="text" name="source" class="sel-input auto-input" id="depFrom" placeholder="From" value="">
                                                ...
                                                <div class="custom-sel-input-block">
                                                    <label for="arrivalTo" class="h-16 color-medium-gray">To</label>
                                                    <input type="text" name="destination" class="sel-input auto-input" id="arrivalTo" placeholder="To" value="">
                                                    <div class="slector-wrapper"></div>
                                                </div>
                                            ...
                                            <div class="d-xl-flex align-items-center gap-24 d-lg-block ">
                                                <div class="input-date-picker">
                                                    <label for="dep" class="h-16 color-medium-gray">Departing</label>
                                                    <input type="text" name="departing" class="sel-input date_from" id="dep" placeholder="Aug 18, 2023" value="">
                                                </div>
                                                <div class="input-date-picker">
                                                    <label for="arrival" class="h-16 color-medium-gray">Returning</label>
                                                    <input type="text" name="returning" class="sel-input date_to" id="arrival" placeholder="Aug 20, 2023" value="">
                                                </div>
    
                                                <div class="custom-sel-input-block">
                                                    <div class="h-16 color-medium-gray">Passengers and Class</div>
                                                    <div class="seat-booking color-medium-gray"> <span class="total-pasenger">0</span> Passengers /
   ...
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          ...
          <form action="flight-listing.jsp" method="post">
                                        ...
                                        <div class="booking-info mb-32">
                                            <div class="d-xl-flex align-items-center gap-24 d-lg-block d-flex">
                                                <div class="custom-sel-input-block">
                                                    ...
                                                    <input type="text" name="source" class="sel-input auto-input" id="flightFrom" placeholder="From">
                                                    <div class="slector-wrapper"></div>
                                                </div>
                                                <div class="arrows">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none">
                                                ...
                                                <div class="custom-sel-input-block">
                                                    <label for="flightGo" class="h-16 color-medium-gray">To</label>
                                                    <input type="text" name="destination" class="sel-input auto-input" id="flightGo" placeholder="To">
                                                    <div class="slector-wrapper"></div>
                                                </div>
                                                <div class="vertical-line d-xl-block d-none"></div>
                                            </div>
                                            <div class="d-xl-flex align-items-center gap-24 d-lg-block ">
                                                <div class="input-date-picker">
                                                    <label for="flightgone" class="h-16 color-medium-gray">Departing</label>
                                                    <input type="text" name="departing" class="sel-input date_from" id="flightgone" placeholder="Aug 18, 2023">
                                                </div>
                                                <div class="input-date-picker">
                                                    <label for="returnTime" class="h-16 color-medium-gray">Returning</label>
                                                    <input type="text" name="returning" class="sel-input date_to" id="returnTime" placeholder="Aug 20, 2023">
                                                </div>
                                                <div class="custom-sel-input-block">
                                                    <div class="h-16 color-medium-gray" id="passengers">Passengers and Class</div>
                                                    <div class="seat-booking color-medium-gray"><span class="total-pasenger">0</span> Passengers /
                                                        <span class="pasenger-class">Business</span>
                                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-5 col-lg-5 offset-lg-0 offset-md-2 col-md-5 offset-sm-2 col-sm-5">
                 ...
                 <form action="flight-listing.jsp" method="post">
                                ...
                                <div class="tab-pane" id="status">
                                    <div class="booking-bar">
                                        <ul class="nav nav-tabs " data-bs-tabs="tabs">
                                            <li class="nav-item">
                                                <a href="#byRoute" class="nav-link active" aria-current="true" data-bs-toggle="tab"> By Route
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="#flightNo" class="nav-link " aria-current="false" data-bs-toggle="tab"> By flight Number
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-xl-10 col-lg-10">
                                                        <div class="booking-info v-2 d-md-flex d-inline-block justify-content-between">
                                                                ...
                                                                <div class="custom-sel-input-block m-0">
                                                                    <input type="text" name="source" class="sel-input auto-input" id="flightDepart" placeholder="From">
                                                                    <div class="slector-wrapper"></div>
                                                                </div>
                                                                <div class="custom-sel-input-block m-0 d-flex flex-row align-items-center">
                                                                    <div class="vertical-line d-md-flex d-none"></div>
                                                                    <input type="text" name="destination" class="sel-input auto-input" id="flightArrive" placeholder="To">
                                                                    <div class="slector-wrapper"></div>
                                                                </div>
                                                            
                                                            <div>
                                                                <div class="input-date-picker date-time m-0">
                                                                    <input type="text" name="departing" class="sel-input date_from" id="flightTimeDate" placeholder="Aug 20, 2023">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-xl-10 col-lg-10">
                                                        <div class="booking-info v-2 d-md-flex d-inline-block justify-content-between">
                                                                ...
                                                                <div class="custom-sel-input-block m-0">
                                                                    <input type="text" name="source" class="sel-input auto-input" id="flightDepat" placeholder="From">
                                                                    <div class="slector-wrapper"></div>
                                                                </div>
                                                                <div class="custom-sel-input-block m-0 d-flex flex-row align-items-center">
                                                                    <div class="vertical-line d-md-flex d-none"></div>
                                                                    <input type="text" name="destination" class="sel-input auto-input" id="flightArive" placeholder="To">
                                                                    <div class="slector-wrapper"></div>
                                                                </div>
                                                            
                                                            <div>
                                                                <div class="input-date-picker date-time m-0">
                                                                    <input type="text" name="departing" class="sel-input date_from" id="flightTieDate" placeholder="Aug 20, 2023">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
     ...
     <!--******************************** list of flights start ******************************************-->
		...
		List<Filghts_Detail> list = null;
		if(source==null && destination==null)
		{
			list =dao.getAllFlight_Detail();	
		}
		else{
			
			%>
			<a href="flight-listing.jsp" style="color:blue;">SHOW ALL FLIGHTS</a><br><br>
			<% 
			if(returning==null){
				list = dao.getCheckFlight_status(source, destination, departing);
				...
				<a href="flight-listing.jsp" style="color:blue;">SHOW ALL FLIGHTS</a><br><br>
				<% 
			list = dao.getSearchFlight_Detail(source, destination,departing,returning);
			}
		}
		if (list.isEmpty())
		{ %> 
			<p/>There is no Any Flight Avalible<p>
		<% }
     
     for(Filghts_Detail fd:list)
     {
    	%>
                          ...
                          <div class="flight-block bg-white light-shadow p-24 br-10 mb-16" data-sal="slide-up" data-sal-duration="800" data-sal-delay="100" data-sal-easing="ease-in-out">
                                ...
                                <div class="flight-area">
                                    <div class="airline-name">
                                        ...
                                        <div>
                                            <h5 class="lightest-black mb-8"><% out.println(fd.getFlight_name()); %></h5>
                                            <h6 class="dark-gray"><% out.println(fd.getFlight_code()); %> </h6>
                                        </div>
                                    </div>
                                    <div class="flight-detail">
                                        <div class="flight-departure">
                                            <h5 class="color-black"> <% out.println(fd.getTakeOff_Time()); %></h5>
                                            <h5 class="dark-gray text-end"> </h5>
                                        </div>
                                        <div class="d-inline-flex align-items-center gap-8">
                                            <span class=""><% out.println(fd.getSource()); %></span>
                                            ...
                                            <span class=""><% out.println(fd.getDestination()); %></span>
                                        </div>
                                        <div class="flight-departure">
                                            <h5 class="color-black"><% out.println(fd.getArrival_Time()); %></h5>
                                            <h5 class="dark-gray"> </h5>
                                        </div>
                                    </div>
                                    <div class="flight-button">
                                        <div class="amount">
                                             
                                            <h6 class="color-black text-end"><% out.println(fd.getPrice()); %></h6>
        ...
        // out.println(user);
         if(user==null)
        	 {
        	 %>
        	  <a href="login_page.jsp" class="cus-btn btn-sec">Book Now</a>
        	 <%
        	 }else{
        		 %>
        		 <a href="flight-booking.jsp?code=<%= fd.getFlight_code() %>" class="cus-btn btn-sec">Book Now</a> 
        	<% 
        	  }
        	 %>
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <h5 class="color-black"> </h5>
                                    <div>
                                        <a href="#" class="accordion-button color-primary h5 collapsed" data-bs-toggle="collapse" data-bs-target="#flightDetail" aria-expanded="true"> <i class="fal fa-chevron-down color-primary "></i>&nbsp;Flight Detail</a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row bg-white br-10 light-shadow p-24 m-0 align-items-center">
                                    <div class="col-lg-3 col-sm-4">
                                        <div class="time-detail">
                                            <h6 class="flight-date mb-32"> <% out.println(fd.getDeparting()); %></h6>
                                        ...
                                        <div class="detail-block">
                                            <div class="d-sm-flex d-block align-items-center gap-24">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <h6 class="dark-gray">Operated by  </h6>
                                                    <h6 class="dark-gray"><% out.println(fd.getCabin()); %> | Flight FK234 | Aircraft</h6>
