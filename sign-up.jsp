            ...
            <div class="row">
                <div class="col-xl-4 col-lg-6 col-md-7 mb-lg-0 mb-48">
                    <div class="form-block">
                        ...
                        <h2 class="mb-30 light-black">Create an account</h2>
                              
                        <div id="message" class="alert-msg"><%@include file="message.jsp" %></div>
        ...
        -->                    
             ...
             <!-- from strat -->
                      ...
                      <form action="Register_servlet" method="post">
                       ...
                       <div class="col-sm-6">
                      <div class="mb-24">
                       <input type="text" class="form-control" id="first-name" name="first-name" required="" placeholder="First Name">
                       </div>
                       </div>
                        <div class="col-sm-6">
                       <div class="mb-24">
                        <input type="text" class="form-control" id="last-name" name="last-name" required="" placeholder="Last Name">
                        </div>
                        </div>
                         <div class="col-sm-6">
                        <div class="mb-24">
                         <input type="email" class="form-control" id="signup-mail" name="email" required="" placeholder="Email">
                         </div>
                         </div>
                          <div class="col-sm-6">
                         <div class="mb-24">
                         <input type="password" class="form-control" id="create-password" name="password" required="" placeholder="Password">
                         </div>
                         </div>
                          <div class="col-sm-6">
                         <div class="mb-24">
                                 ...
                                 <div class="col-sm-6 col-6">
                                    <div class="mb-24">
                                        <div class="input-date-picker">
                                            <input type="text" class="sel-input date_from form-control" name="dob" id="dob" required="" placeholder="Date of Birth">
                                        </div>
                                    </div>
                                </div>
                              <div class="col-sm-6 col-6">
                   ...
                   <!--   <input type="submit" class="cus-btn small-pad mb-24" value="Create Account">   -->
